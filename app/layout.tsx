...
export const metadata: Metadata = {
  ...
  description: 'Portfolio of Rutvij Sathe, Software Engineer II at American Express. Full Stack Developer specializing in React.js, Next.js, Node.js, and AdonisJS.',
  keywords: ['Software Engineer', 'Full Stack Developer', 'React', 'Next.js', 'Node.js', 'TypeScript', 'Portfolio'],
