  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-6">
      ...
      <div>
        ...
        {errors.subject && (
          <p className="mt-1 text-xs sm:text-sm text-red-600 dark:text-red-400">{errors.subject.message}</p>
        )}
      </div>
      ...
      <div>
        ...
        />
        {errors.message && (
          <p className="mt-1 text-xs sm:text-sm text-red-600 dark:text-red-400">{errors.message.message}</p>
        )}
      </div>
